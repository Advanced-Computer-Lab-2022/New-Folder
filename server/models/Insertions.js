...
// insert new courses
async function insertCourse(name , field, priceMag , priceCurr , description , image , introVideo , rating, ratingNo , reviews , instructorID,trainees , subtitles) {
...
async function insertInstructor(email , username, password , gender , firstName , lastName , image , country, about , rating ,ratingNo,courses , reviews) {
...
async function insertTrainee(email , username, password , fields,gender , firstName , lastName , image , country ,courses , isCorporate) {
...
async function insertExcercises (statement, firstAns , secondAns , thirdAns , forthAns , correctIdx) {
