...
function CourseCard(props) {
  ...
  return (
    <div className="card" onClick={(e) => navigate("/course/"+props.course._id)}>
      <div className="card__body">
        <img className="card__image" src={ props.course.image === ""? "../../public/assets/course/course-default.png": props.course.image} />
        <div className="card__instructor">

          <p className="instructor__name">{props.course.instructorInfo == undefined ? "unknown" : props.course.instructorInfo.instructorName}</p>
        </div>
        ...
        <div className="card__details">
          <div className="card__details__title">
           ...
           <div className="card__details__description">
              <p className="card__description">{props.course.description ?? "No description"}</p>
           </div>
          ...
          <div className="card__details__price__rating">
            <div className="card__details__rating">
              ...
              <span className="card__rating__number">({props.course.reviews.length} reviews)</span>  
            </div>
          
            <p className="card__price">{price} <sup>{currency}</sup></p>
          </div>
